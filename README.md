...
**React todo app:** This is a Todo project with react developed for the purpose of learning how to create a react app, create a use components, handle events, style application, Harmburger menu etc.
...
- **Menu button, sidebar, home page and about page.**
...
- In order to clone this work to local machine get the 'url' of this repo.
- use the terminal of your machine or the vscode or Git Bash. 
...
This project is [MIT](https://github.com/lugard1/react-todo-app/blob/component/MIT.md) licensed.
